    ...
    PSTR cmdLine, int showCmd)
{
    ...
    try
    {
        DisplacementMappingApp theApp(hInstance);
...
DisplacementMappingApp::DisplacementMappingApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{

}

DisplacementMappingApp::~DisplacementMappingApp()
{
    if(md3dDevice != nullptr)
        FlushCommandQueue();
}

bool DisplacementMappingApp::Initialize()
{
...
void DisplacementMappingApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void DisplacementMappingApp::OnResize()
{
    D3DApp::OnResize();
...
void DisplacementMappingApp::Update(const GameTimer& gt)
{
    OnKeyboardInput(gt);
...
void DisplacementMappingApp::Draw(const GameTimer& gt)
{
...
void DisplacementMappingApp::UpdateImgui(const GameTimer& gt)
{
...
void DisplacementMappingApp::OnMouseDown(WPARAM btnState, int x, int y)
{
...
void DisplacementMappingApp::OnMouseUp(WPARAM btnState, int x, int y)
{
    ImGuiIO& io = ImGui::GetIO();
...
void DisplacementMappingApp::OnMouseMove(WPARAM btnState, int x, int y)
{
    ImGuiIO& io = ImGui::GetIO();
...
void DisplacementMappingApp::OnKeyboardInput(const GameTimer& gt)
{
...
void DisplacementMappingApp::AnimateMaterials(const GameTimer& gt)
{
...
void DisplacementMappingApp::UpdatePerObjectCB(const GameTimer& gt)
{
...
void DisplacementMappingApp::UpdateMaterialBuffer(const GameTimer& gt)
{
    MaterialLib& matLib = MaterialLib::GetLib();
...
void DisplacementMappingApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	auto invViewProj = XMMatrixInverse(&detViewProj, viewProj);
...
void DisplacementMappingApp::LoadTextures()
{
    TextureLib& texLib = TextureLib::GetLib();
    texLib.Init(md3dDevice.Get(), *mUploadBatch.get());
}

void DisplacementMappingApp::LoadGeometry()
{
...
void DisplacementMappingApp::BuildRootSignature()
{
...
void DisplacementMappingApp::BuildCbvSrvUavDescriptorHeap()
{
    CbvSrvUavHeap& cbvSrvUavHeap = CbvSrvUavHeap::Get();
...
void DisplacementMappingApp::BuildShadersAndInputLayout()
{
    ShaderLib::GetLib().Init(md3dDevice.Get());
}

void DisplacementMappingApp::BuildPSOs()
{
    PsoLib::GetLib().Init(
        md3dDevice.Get(),
        mBackBufferFormat,
...
void DisplacementMappingApp::BuildFrameResources()
{
...
void DisplacementMappingApp::BuildMaterials()
{
    MaterialLib::GetLib().Init(md3dDevice.Get());
}

void DisplacementMappingApp::AddRenderItem(
    RenderLayer layer, 
...
void DisplacementMappingApp::AddDisplacementMappedRenderItem(
    RenderLayer layer,
...
void DisplacementMappingApp::BuildRenderItems()
{
    MaterialLib& matLib = MaterialLib::GetLib();
...
void DisplacementMappingApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
