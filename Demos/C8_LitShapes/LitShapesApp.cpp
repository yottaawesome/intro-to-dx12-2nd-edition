...
LitShapesApp::LitShapesApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{

}

LitShapesApp::~LitShapesApp()
{
...
void LitShapesApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void LitShapesApp::UpdateImgui(const GameTimer& gt)
{
...
void LitShapesApp::OnKeyboardInput(const GameTimer& gt)
{
}

void LitShapesApp::AnimateMaterials(const GameTimer& gt)
{
}
...
void LitShapesApp::UpdatePerObjectCB(const GameTimer& gt)
{
...
void LitShapesApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void LitShapesApp::BuildCbvSrvUavDescriptorHeap()
{
    CbvSrvUavHeap& cbvSrvUavHeap = CbvSrvUavHeap::Get();
...
void LitShapesApp::BuildFrameResources()
{
...
void LitShapesApp::BuildMaterials()
{
    ...
    auto AddMaterial = [&matIndex, this](
...
void LitShapesApp::AddRenderItem(RenderLayer layer, const DirectX::XMFLOAT4X4& world, Material* mat, MeshGeometry* geo, SubmeshGeometry& drawArgs)
{
...
void LitShapesApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
