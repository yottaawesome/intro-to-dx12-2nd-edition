...
private:
    ...
    std::unique_ptr<Prepass> mPrepass = nullptr;

    uint32_t mShapeVertexBufferBindlessIndex = -1;
    uint32_t mShapeIndexBufferBindlessIndex = -1;
    uint32_t mOrbBaseVertexBufferBindlessIndex = -1;
    uint32_t mOrbBaseIndexBufferBindlessIndex = -1;
    uint32_t mColumnRoundBrokenVertexBufferBindlessIndex = -1;
    uint32_t mColumnRoundBrokenIndexBufferBindlessIndex = -1;
    uint32_t mColumnSquareBrokenVertexBufferBindlessIndex = -1;
    uint32_t mColumnSquareBrokenIndexBufferBindlessIndex = -1;
    uint32_t mColumnSquareVertexBufferBindlessIndex = -1;
    uint32_t mColumnSquareIndexBufferBindlessIndex = -1;
