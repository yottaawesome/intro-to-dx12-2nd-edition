...
void CrateApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void CrateApp::UpdateImgui(const GameTimer& gt)
{
...
void CrateApp::UpdatePerObjectCB(const GameTimer& gt)
{
...
void CrateApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void CrateApp::AddRenderItem(RenderLayer layer, const DirectX::XMFLOAT4X4& world, const XMFLOAT4X4& texTransform, Material* mat, MeshGeometry* geo, SubmeshGeometry& drawArgs)
{
...
std::unique_ptr<MeshGeometry> CrateApp::BuildShapeGeometry(
    ID3D12Device* device,
