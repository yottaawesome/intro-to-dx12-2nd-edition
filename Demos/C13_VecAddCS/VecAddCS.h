...
class VecAddCS : public D3DApp
{
public:
    VecAddCS(HINSTANCE hInstance);
...
private:
    ...
    std::unique_ptr<MeshGeometry> BuildShapeGeometry(
        ID3D12Device* device,
...
private:
    ...
    uint32_t mBufferIndexA = 0;
    uint32_t mBufferIndexB = 0;
    uint32_t mBufferOutputIndex = 0;
