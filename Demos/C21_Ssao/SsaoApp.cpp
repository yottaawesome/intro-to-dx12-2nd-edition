...
void SsaoApp::UpdateImgui(const GameTimer& gt)
{
...
void SsaoApp::UpdatePerObjectCB(const GameTimer& gt)
{
...
void SsaoApp::BuildCbvSrvUavDescriptorHeap()
{
    CbvSrvUavHeap& cbvSrvUavHeap = CbvSrvUavHeap::Get();
...
void SsaoApp::AddRenderItem(RenderLayer layer, const XMFLOAT4X4& world, const XMFLOAT4X4& texTransform, Material* mat, MeshGeometry* geo, SubmeshGeometry& drawArgs)
{
