...
void QuatApp::UpdateImgui(const GameTimer& gt)
{
...
void QuatApp::UpdatePerObjectCB(const GameTimer& gt)
{
...
void QuatApp::BuildCbvSrvUavDescriptorHeap()
{
    CbvSrvUavHeap& cbvSrvUavHeap = CbvSrvUavHeap::Get();
...
RenderItem* QuatApp::AddRenderItem(RenderLayer layer, const XMFLOAT4X4& world, const XMFLOAT4X4& texTransform, Material* mat, MeshGeometry* geo, SubmeshGeometry& drawArgs)
{
