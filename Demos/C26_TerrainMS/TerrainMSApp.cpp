//***************************************************************************************
// TerrainMSApp.cpp by Frank Luna (C) 2015 All Rights Reserved.
//***************************************************************************************

#include "TerrainMSApp.h"
...
TerrainMSApp::TerrainMSApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
...
TerrainMSApp::~TerrainMSApp()
{
    if(md3dDevice != nullptr)
        FlushCommandQueue();
}

bool TerrainMSApp::Initialize()
{
    ...
    TerrainMS::InitInfo terrainInitInfo;
...
void TerrainMSApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void TerrainMSApp::Update(const GameTimer& gt)
{
    OnKeyboardInput(gt);
...
void TerrainMSApp::Draw(const GameTimer& gt)
{
...
void TerrainMSApp::UpdateImgui(const GameTimer& gt)
{
...
void TerrainMSApp::OnMouseDown(WPARAM btnState, int x, int y)
{
...
void TerrainMSApp::OnMouseUp(WPARAM btnState, int x, int y)
{
    ImGuiIO& io = ImGui::GetIO();
...
void TerrainMSApp::OnMouseMove(WPARAM btnState, int x, int y)
{
    ImGuiIO& io = ImGui::GetIO();
...
void TerrainMSApp::OnKeyboardInput(const GameTimer& gt)
{
...
void TerrainMSApp::AnimateMaterials(const GameTimer& gt)
{
	
}

void TerrainMSApp::UpdatePerObjectCB(const GameTimer& gt)
{
...
void TerrainMSApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void TerrainMSApp::UpdateShadowTransform(const GameTimer& gt)
{
...
void TerrainMSApp::EmitExplosionParticles(const GameTimer& gt)
{
    TextureLib& texLib = TextureLib::GetLib();
...
void TerrainMSApp::EmitRainParticles(const GameTimer& gt)
{
    TextureLib& texLib = TextureLib::GetLib();
...
void TerrainMSApp::ReadParticleCounts(const GameTimer& gt)
{
...
void TerrainMSApp::LoadTextures()
{
    TextureLib& texLib = TextureLib::GetLib();
    texLib.Init(md3dDevice.Get(), *mUploadBatch.get());
}

void TerrainMSApp::LoadGeometry()
{
...
void TerrainMSApp::BuildRootSignatures()
{
...
void TerrainMSApp::BuildCommandSignatures()
{
...
void TerrainMSApp::BuildCbvSrvUavDescriptorHeap()
{
    CbvSrvUavHeap& cbvSrvUavHeap = CbvSrvUavHeap::Get();
...
void TerrainMSApp::BuildShaders()
{
    ShaderLib::GetLib().Init(md3dDevice.Get());
}

void TerrainMSApp::BuildPSOs()
{
    PsoLib::GetLib().Init(
        md3dDevice.Get(),
        mBackBufferFormat,
...
void TerrainMSApp::BuildFrameResources()
{
...
void TerrainMSApp::BuildMaterials()
{
    MaterialLib::GetLib().Init(md3dDevice.Get());
}

void TerrainMSApp::AddRenderItem(RenderLayer layer, const XMFLOAT4X4& world, const XMFLOAT4X4& texTransform, Material* mat, MeshGeometry* geo, SubmeshGeometry& drawArgs)
{
...
void TerrainMSApp::BuildRenderItems()
{
    MaterialLib& matLib = MaterialLib::GetLib();
...
void TerrainMSApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
